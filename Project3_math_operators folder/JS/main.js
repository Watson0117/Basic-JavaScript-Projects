...
function RAN() {
    ...
    //This one dident work at first but after some reserche
    // it work when I add the math.floor befor the random bit
    // The math.random() gets a randome number and the * 10
    //make sure that the random number dosent go over 10.
}
